# Mule standalone v3.9.0 with Hawkore's cluster module
...
| -------------------------------------------- | ---------- | ------------------------ |
| **docker.hawkore.com/hk/mule-hk:3.9.0**      |            | hawkore/oraclejdk:8u191 |
| **docker.hawkore.com/hk/mule-ee-hk:3.9.0**   |            | hawkore/oraclejdk:8u191 |
